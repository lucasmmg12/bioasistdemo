...
// ═══════════════════════════════════════════════
// SINGLE FINDING PDF — R GC 05 / 06 / 08 FORMAT
// ═══════════════════════════════════════════════

import { exportFindingPDF, exportSeguimiento as exportSeguimientoPDF } from '../utils/pdfExporter';

export function exportFindingToPDF(finding: Finding) {
  exportFindingPDF(finding);
}
...
export function exportSeguimiento(findings: Finding[]) {
  exportSeguimientoPDF(findings);
}
